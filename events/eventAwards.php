...
<div id="myDIV102">
        ...
        <h1 class=" textheader2-1size" style="text-align:center;font-weight:bold">Awards</h1><br>

  <p>
  <li style="margin-left:30px">Best Student Paper (Session Wise)</li><br>
  <li style="margin-left:30px">Best Innovative Paper</li><br>
  <li style="margin-left:30px">Best Doctoral Thesis</li><br>
<li style="margin-left:30px">Best Application Paper</li><br>
