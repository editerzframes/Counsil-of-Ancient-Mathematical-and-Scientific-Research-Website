...
<p style="margin-left:10px"> Delegates need to download the latest version of Zoom Software for laptop or smart phone or tab from <a href="http://zoom.us/download#mobileapp">http://zoom.us/download#mobileapp</a></p>

    <p>
    &nbsp; <li style="margin-left:30px">After registration, GIAP will share conference meeting password in mail. This password need to be used to attend the meeting during conference.</li><br>
     &nbsp;<li style="margin-left:30px">Delegates need to use 4G internet or high speed Wi-Fi or Broadband connection to join the conference.</li><br>
    &nbsp; <li style="margin-left:30px">It is advisable to use earphone and wired speakers for better audio experience.</li><br>
   &nbsp;  <li style="margin-left:30px">In case of any query use chat option given at the bottom of conference page.</li><br>
</div>
