...
$sql = "SELECT firstName, lastName, affliation, biography, ksfile_name FROM ks WHERE ksID='".$var1."'";
$result = $db->query($sql);
...
<div class="form-style-8">
  ...
  <form action="updateKS.php" method="post" enctype="multipart/form-data">
